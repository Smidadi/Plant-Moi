...
class ResearchUser extends Component {
  ...
  constructor(props) {
    super(props);
    this.state = { 
      researchUser: this.props.placeholder,
      inputValue:'',
      propositions:[]
    }
  }
  ...
  render() {
    return (
        <div className="col-9 research">
            <Logo />
            <input type="text" id="searchbar" name="search" onChange={this.changeInputValue}  onKeyDown= {this.handleKeyDown} placeholder={this.state.researchUser} list={"propositions"}/>
